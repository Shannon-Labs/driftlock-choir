...
def main():
    ...
    ax.plot(iters, rms_ps_sync, color="#1f77b4")
    ax.plot(iters, rms_ps_async, color="#ff7f0e", linestyle="--")
    ax.axhline(100, color="#2ca02c", linestyle=":")
    ax.set_xlabel("")
    ax.set_ylabel("")
    ax.set_title("Fig. 4 — Convergence")
