...
OUT_DIR="${ROOT_DIR}/dist/us_nonprovisional_packet"
...
echo "⟹ Copying US spec HTML"
cp -f "${ROOT_DIR}/patent/nonprovisional/US_Spec.html" "$OUT_DIR/spec.html"
cp -f "${ROOT_DIR}/patent/nonprovisional/US_CLAIMS.md" "$OUT_DIR/claims.md"
