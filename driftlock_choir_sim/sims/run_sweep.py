...
from driftlock_choir_sim.dsp.impairments import apply_cfo, apply_phase_noise, apply_sco, rapp_soft_clip, aperture_branch
...
from driftlock_choir_sim.dsp.metrics import papr_db
from driftlock_choir_sim.dsp.crlb import delay_crlb_std
            ...
            for m in m_list:
                for df in df_list:
                    for beff in beff_list:
                        ...
                        from driftlock_choir_sim.dsp.metrics import ber_qpsk_awgn
                        row = {
                            "seed": base_seed,
                            "snr_db": snr,
                            "m": m,
